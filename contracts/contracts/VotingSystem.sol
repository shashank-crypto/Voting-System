...
// take the election info during construction of the contract
    ...
    function approveCandidate(address _address) public onlyAdmin {
    ...
    function getElectionInfo() public view returns(string memory, Level, ElectionType) {
        return(electionInfo.name, electionInfo.level, electionInfo.electionType);
    }
